...
#設定16nm製程路徑檔，如果有memory compiler的檔案db檔的路徑，記得在這邊設定
...
set Path_Syn		"/MasterClass/M143010068_HDL/HW3/Gate_Level/SYN/dc_out_file/"
set Dump_file_name "thumb_pipe_syn"
...
# comb seq 寫在一起用
uplevel #0 { report_timing  -to { s1/*/D } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 3 -sort_by group } > $Path_Syn/timing_report_stage1.txt
uplevel #0 { report_timing  -to { s2/*/D } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 3 -sort_by group } > $Path_Syn/timing_report_stage2.txt
uplevel #0 { report_timing  -to { s3/*/D } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 3 -sort_by group } > $Path_Syn/timing_report_stage3.txt
uplevel #0 { report_timing  -to { s4/*/D } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 3 -sort_by group } > $Path_Syn/timing_report_stage4.txt
