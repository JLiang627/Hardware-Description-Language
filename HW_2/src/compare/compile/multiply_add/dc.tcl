...
set Path_Top		"/MasterClass/M143010068_HDL/HW2/compare/rtl/multiply_add.v"
set Path_Syn		"/MasterClass/M143010068_HDL/HW2/compare/gate_level/Delay/dc_out_file/multiply_add/"
set Dump_file_name "multiply_add"
#設定Top module 名稱，需跟自行設計之電路的top module name相同
set Top				"multiply_add"
...
# current_design $Top
analyze -format verilog { /MasterClass/M143010068_HDL/HW2/compare/rtl/multiply_add.v }
elaborate $Top
