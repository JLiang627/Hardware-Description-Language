...
set RTL_PATH "/MasterClass/M143010068_HDL/HW2/clock_gating/rtl"
...
set Path_Top		"/MasterClass/M143010068_HDL/HW2/clock_gating/rtl/hw2_clockgating.v"
set Path_Syn		"/MasterClass/M143010068_HDL/HW2/clock_gating/gate_level/Delay/"
set Dump_file_name "hw2_clockgating"
#設定Top module 名稱，需跟自行設計之電路的top module name相同
set Top				"hw2_clockgating"
#Specify Clock，clock名需和top module中clk port相同
set Clk_pin			"clk"
set Clk_period		"0.485214"
...
#uplevel #0 { report_timing  -through { u_stage1/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 4 -sort_by group  > $Path_Syn/s1_timing_report.txt}
#uplevel #0 { report_timing  -through { u_stage2/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 4 -sort_by group  > $Path_Syn/s2_timing_report.txt}
# 如果combinational跟sequential寫在同一個module
# module name = s1/s2
uplevel #0 { report_timing  -to { u_stage1/*/D } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 4 -sort_by group } > $Path_Syn/timing_report_stage1.txt
uplevel #0 { report_timing  -to { u_stage2/*/D } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 4 -sort_by group } > $Path_Syn/timing_report_stage2.txt
