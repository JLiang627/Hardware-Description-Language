...
// Version   : T-2022.03
// Date      : Sat Oct 18 15:27:39 2025
/////////////////////////////////////////////////////////////


module add_sub_2_DW01_addsub_0 ( A, ADD_SUB, SUM, \B[8] , \B[6] , \B[5] , 
        \B[4] , \B[3] , \B[2] , \B[1] , \B[0]  );
  input [8:0] A;
  output [8:0] SUM;
...
module add_sub_2 ( a, b, s, d );
  ...
  add_sub_2_DW01_addsub_0 r368 ( .A({a[7], a}), .ADD_SUB(n9), .SUM({d[15], 
