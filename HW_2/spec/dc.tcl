...
set Path_Top		"../rtl"
set Path_Syn		"../gate_level/Delay"
set Dump_file_name "clock_gating_syn"
#設定Top module 名稱，需跟自行設計之電路的top module name相同
set Top				"clock_gating"
...
# current_design $Top
analyze -format verilog { /home/M133040041_HDL/HW2/clock_gating/rtl/clock_gating.v }
elaborate $Top
