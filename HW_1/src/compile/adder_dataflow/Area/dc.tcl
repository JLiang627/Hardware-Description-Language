...
set Path_Top		"/MasterClass/M143010068_HDL/HW1/RTL/adder_dataflow/adder_dataflow.v"
set Path_Syn		"/MasterClass/M143010068_HDL/HW1/gate_level/adder_dataflow/Area/dc_out_file/"
set Dump_file_name "adder_dataflow"
#設定Top module 名稱，需跟自行設計之電路的top module name相同
set Top				"adder_dataflow"
#Specify Clock，clock名需和top module中clk port相同
set Clk_pin			"clk"
set Clk_period		"0.92"

# [ Read Design File ]
#如果設計有parmeter設計，read_file指定不能用，需使用analyze + elaborate指令並自行更改路徑
