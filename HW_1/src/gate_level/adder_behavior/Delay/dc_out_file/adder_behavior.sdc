...
# Created by write_sdc on Thu Oct  9 17:47:40 2025
...
set_max_area 0
create_clock -name clk  -period 0.091  -waveform {0 0.0455}
set_max_delay 0.091  -from [list [get_ports {a[31]}] [get_ports {a[30]}] [get_ports {a[29]}]       \
