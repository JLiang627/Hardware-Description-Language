...
# Created by write_sdc on Thu Oct  9 19:23:42 2025
...
set_max_area 0
create_clock -name clk  -period 0.12  -waveform {0 0.06}
set_max_delay 0.12  -from [list [get_ports {a[31]}] [get_ports {a[30]}] [get_ports {a[29]}]       \
