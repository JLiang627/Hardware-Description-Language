...
module FA_structure_0 ( a, b, cin, s, cout );
  ...
  MAOI222D4BWP16P90LVT U1 ( .A(n2), .B(n3), .C(n4), .ZN(cout) );
  CKND16BWP16P90LVT U2 ( .I(a), .ZN(n2) );
  CKND16BWP16P90LVT U3 ( .I(cin), .ZN(n3) );
  CKND16BWP16P90LVT U4 ( .I(b), .ZN(n4) );
  XOR3D4BWP16P90LVT U5 ( .A1(b), .A2(a), .A3(cin), .Z(s) );
endmodule
...
module FA_structure_1 ( a, b, cin, s, cout );
  ...
  MOAI22D2BWP16P90LVT U1 ( .A1(n2), .A2(n3), .B1(a), .B2(b), .ZN(cout) );
  CKND2BWP20P90 U2 ( .I(a), .ZN(n1) );
  CKND2BWP16P90LVT U3 ( .I(cin), .ZN(n2) );
  XNR2D2BWP16P90 U4 ( .A1(cin), .A2(n3), .ZN(s) );
  XOR2D1BWP16P90LVT U5 ( .A1(n1), .A2(b), .Z(n3) );
endmodule
...
module FA_structure_2 ( a, b, cin, s, cout );
  ...
  INVD4BWP16P90LVT U1 ( .I(cin), .ZN(n1) );
  INVD1BWP16P90 U2 ( .I(cin), .ZN(n2) );
  CKND1BWP16P90 U3 ( .I(n2), .ZN(n3) );
  XNR2D1BWP16P90LVT U4 ( .A1(n3), .A2(n6), .ZN(s) );
  OAI22D4BWP16P90LVT U5 ( .A1(n1), .A2(n6), .B1(n5), .B2(n4), .ZN(cout) );
...
module FA_structure_3 ( a, b, cin, s, cout );
  ...
  DEL025D1BWP16P90LVT U1 ( .I(cin), .Z(n1) );
  XNR2D1BWP16P90 U2 ( .A1(n5), .A2(n1), .ZN(s) );
  INVD4BWP16P90LVT U3 ( .I(cin), .ZN(n4) );
  OAI22D4BWP16P90LVT U4 ( .A1(n4), .A2(n5), .B1(n3), .B2(n2), .ZN(cout) );
...
module FA_structure_4 ( a, b, cin, s, cout );
  ...
  OAI22D4BWP16P90LVT U5 ( .A1(n4), .A2(n5), .B1(n3), .B2(n2), .ZN(cout) );
  INVD1BWP16P90LVT U6 ( .I(a), .ZN(n3) );
  INVD1BWP16P90LVT U7 ( .I(b), .ZN(n2) );
endmodule
...
module FA_structure_5 ( a, b, cin, s, cout );
  ...
  CKND2BWP16P90LVT U1 ( .I(n1), .ZN(n5) );
  XOR2D1BWP16P90LVT U2 ( .A1(n5), .A2(n6), .Z(s) );
  DEL025D1BWP16P90 U3 ( .I(cin), .Z(n1) );
  INVD4BWP16P90LVT U4 ( .I(cin), .ZN(n2) );
  OAI22D4BWP16P90LVT U5 ( .A1(n2), .A2(n6), .B1(n4), .B2(n3), .ZN(cout) );
  INVD1BWP16P90LVT U6 ( .I(a), .ZN(n4) );
  XOR2D2BWP16P90LVT U7 ( .A1(n4), .A2(b), .Z(n6) );
...
module FA_structure_6 ( a, b, cin, s, cout );
  ...
  CKND2BWP16P90LVT U1 ( .I(n1), .ZN(n2) );
  DEL025D1BWP16P90 U2 ( .I(cin), .Z(n1) );
  INVD4BWP16P90LVT U3 ( .I(cin), .ZN(n5) );
  OAI22D4BWP16P90LVT U4 ( .A1(n5), .A2(n6), .B1(n4), .B2(n3), .ZN(cout) );
  XOR2D1BWP16P90LVT U5 ( .A1(n2), .A2(n6), .Z(s) );
...
module FA_structure_10 ( a, b, cin, s, cout );
  ...
  XOR2D2BWP16P90LVT U6 ( .A1(n3), .A2(b), .Z(n5) );
  INVD1BWP16P90LVT U7 ( .I(b), .ZN(n2) );
endmodule
...
module FA_structure_11 ( a, b, cin, s, cout );
  ...
  XNR2D1BWP16P90LVT U1 ( .A1(n5), .A2(n1), .ZN(s) );
  DEL025D1BWP16P90 U2 ( .I(cin), .Z(n1) );
  INVD4BWP16P90LVT U3 ( .I(cin), .ZN(n4) );
  OAI22D4BWP16P90LVT U4 ( .A1(n4), .A2(n5), .B1(n3), .B2(n2), .ZN(cout) );
  INVD1BWP16P90LVT U5 ( .I(a), .ZN(n3) );
...
module FA_structure_19 ( a, b, cin, s, cout );
  ...
  DEL025D1BWP16P90 U1 ( .I(cin), .Z(n1) );
  INVD4BWP16P90LVT U2 ( .I(cin), .ZN(n4) );
  OAI22D4BWP16P90LVT U3 ( .A1(n4), .A2(n5), .B1(n3), .B2(n2), .ZN(cout) );
  XNR2D2BWP16P90 U4 ( .A1(n5), .A2(n1), .ZN(s) );
  XOR2D1BWP16P90LVT U5 ( .A1(n3), .A2(b), .Z(n5) );
  INVD1BWP16P90LVT U6 ( .I(a), .ZN(n3) );
  INVD1BWP16P90LVT U7 ( .I(b), .ZN(n2) );
endmodule
...
module FA_structure_21 ( a, b, cin, s, cout );
  ...
  XNR2D1BWP16P90 U1 ( .A1(n1), .A2(n5), .ZN(s) );
  DEL025D1BWP16P90 U2 ( .I(cin), .Z(n1) );
  INVD4BWP16P90LVT U3 ( .I(cin), .ZN(n4) );
  OAI22D4BWP16P90LVT U4 ( .A1(n4), .A2(n5), .B1(n3), .B2(n2), .ZN(cout) );
  XOR2D1BWP16P90LVT U5 ( .A1(n3), .A2(b), .Z(n5) );
...
module FA_structure_30 ( a, b, cin, s, cout );
  ...
  DEL025D1BWP16P90 U1 ( .I(cin), .Z(n1) );
  XNR2D8BWP16P90LVT U2 ( .A1(a), .A2(b), .ZN(n5) );
  XNR2D1BWP16P90 U3 ( .A1(n5), .A2(n1), .ZN(s) );
  INVD4BWP16P90LVT U4 ( .I(cin), .ZN(n4) );
  OAI22D4BWP16P90LVT U5 ( .A1(n4), .A2(n5), .B1(n3), .B2(n2), .ZN(cout) );
  INVD1BWP16P90LVT U6 ( .I(a), .ZN(n3) );
  INVD1BWP16P90LVT U7 ( .I(b), .ZN(n2) );
endmodule
...
module FA_structure_31 ( a, b, cin, s, cout );
  ...
  CKND2D4BWP16P90LVT U1 ( .A1(n1), .A2(n2), .ZN(n4) );
  INVD4BWP16P90LVT U2 ( .I(cin), .ZN(n10) );
  ND2D1BWP16P90LVT U3 ( .A1(a), .A2(b), .ZN(n3) );
  ND2D2BWP16P90LVT U4 ( .A1(n3), .A2(n4), .ZN(n11) );
  CKND2BWP16P90LVT U5 ( .I(a), .ZN(n1) );
  CKND4BWP16P90LVT U6 ( .I(b), .ZN(n2) );
  DEL025D1BWP16P90 U7 ( .I(n10), .Z(n5) );
  INVD1BWP16P90 U8 ( .I(n5), .ZN(n6) );
  XNR2D1BWP16P90 U9 ( .A1(n7), .A2(n6), .ZN(s) );
  XNR2D8BWP16P90LVT U10 ( .A1(a), .A2(b), .ZN(n7) );
  OAI22D4BWP16P90LVT U11 ( .A1(n10), .A2(n11), .B1(n9), .B2(n8), .ZN(cout) );
  INVD1BWP16P90LVT U12 ( .I(a), .ZN(n9) );
  INVD1BWP16P90LVT U13 ( .I(b), .ZN(n8) );
endmodule
...
module adder_structure ( s, co, a, b, ci );
  ...
  FA_structure_1 FA_loop_31__FA ( .a(a[31]), .b(b[31]), .cin(carry[31]), .s(
        s[31]), .cout(carry[32]) );
  XOR2D1BWP16P90LVT U2 ( .A1(a[31]), .A2(b[31]), .Z(n1) );
  XOR2D1BWP16P90LVT U3 ( .A1(carry[32]), .A2(n1), .Z(co) );
endmodule
