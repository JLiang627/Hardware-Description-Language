...
# Created by write_sdc on Thu Oct  9 17:13:29 2025
...
set_max_area 0
create_clock -name clk  -period 0.094  -waveform {0 0.047}
set_max_delay 0.094  -from [list [get_ports {a[31]}] [get_ports {a[30]}] [get_ports {a[29]}]       \
