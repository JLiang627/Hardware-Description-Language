...
# Created by write_sdc on Thu Oct  9 17:25:52 2025
...
set_max_area 0
create_clock -name clk  -period 0.92  -waveform {0 0.46}
set_max_delay 0.92  -from [list [get_ports {a[31]}] [get_ports {a[30]}] [get_ports {a[29]}]       \
