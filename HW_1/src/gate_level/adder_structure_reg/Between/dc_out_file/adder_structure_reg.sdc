...
# Created by write_sdc on Thu Oct  9 19:08:14 2025
...
create_clock [get_ports clk]  -period 0.705  -waveform {0 0.3525}
...
set_output_delay -clock clk  0  [get_ports {s_co[32]}]
set_output_delay -clock clk  0  [get_ports {s_co[31]}]
set_output_delay -clock clk  0  [get_ports {s_co[30]}]
set_output_delay -clock clk  0  [get_ports {s_co[29]}]
set_output_delay -clock clk  0  [get_ports {s_co[28]}]
set_output_delay -clock clk  0  [get_ports {s_co[27]}]
set_output_delay -clock clk  0  [get_ports {s_co[26]}]
set_output_delay -clock clk  0  [get_ports {s_co[25]}]
set_output_delay -clock clk  0  [get_ports {s_co[24]}]
set_output_delay -clock clk  0  [get_ports {s_co[23]}]
set_output_delay -clock clk  0  [get_ports {s_co[22]}]
set_output_delay -clock clk  0  [get_ports {s_co[21]}]
set_output_delay -clock clk  0  [get_ports {s_co[20]}]
set_output_delay -clock clk  0  [get_ports {s_co[19]}]
set_output_delay -clock clk  0  [get_ports {s_co[18]}]
set_output_delay -clock clk  0  [get_ports {s_co[17]}]
set_output_delay -clock clk  0  [get_ports {s_co[16]}]
set_output_delay -clock clk  0  [get_ports {s_co[15]}]
set_output_delay -clock clk  0  [get_ports {s_co[14]}]
set_output_delay -clock clk  0  [get_ports {s_co[13]}]
set_output_delay -clock clk  0  [get_ports {s_co[12]}]
set_output_delay -clock clk  0  [get_ports {s_co[11]}]
set_output_delay -clock clk  0  [get_ports {s_co[10]}]
set_output_delay -clock clk  0  [get_ports {s_co[9]}]
set_output_delay -clock clk  0  [get_ports {s_co[8]}]
set_output_delay -clock clk  0  [get_ports {s_co[7]}]
set_output_delay -clock clk  0  [get_ports {s_co[6]}]
set_output_delay -clock clk  0  [get_ports {s_co[5]}]
set_output_delay -clock clk  0  [get_ports {s_co[4]}]
set_output_delay -clock clk  0  [get_ports {s_co[3]}]
set_output_delay -clock clk  0  [get_ports {s_co[2]}]
set_output_delay -clock clk  0  [get_ports {s_co[1]}]
set_output_delay -clock clk  0  [get_ports {s_co[0]}]
