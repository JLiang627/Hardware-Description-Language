...
module FA_structure_reg_0 ( a, b, ci, s, co );
  ...
  NR2D4BWP16P90LVT U1 ( .A1(a), .A2(n6), .ZN(n7) );
  CKND8BWP16P90LVT U2 ( .I(ci), .ZN(n6) );
  CKND1BWP16P90LVT U3 ( .I(n7), .ZN(n2) );
  CKND4BWP16P90LVT U4 ( .I(b), .ZN(n10) );
  ND2D1BWP16P90LVT U5 ( .A1(n9), .A2(n5), .ZN(co) );
  CKND1BWP16P90LVT U6 ( .I(n8), .ZN(n1) );
  ND2D1BWP16P90LVT U7 ( .A1(n3), .A2(n4), .ZN(n9) );
  ND2D1BWP16P90LVT U8 ( .A1(n8), .A2(n2), .ZN(n3) );
  ND2D1BWP16P90LVT U9 ( .A1(ci), .A2(n10), .ZN(n8) );
  ND2D1BWP16P90LVT U10 ( .A1(n1), .A2(n7), .ZN(n4) );
  OR2D1BWP16P90LVT U11 ( .A1(n11), .A2(n10), .Z(n5) );
  INVD1BWP16P90LVT U12 ( .I(a), .ZN(n11) );
  XOR3D1BWP16P90LVT U13 ( .A1(b), .A2(a), .A3(ci), .Z(s) );
endmodule
...
module FA_structure_reg_1 ( a, b, ci, s, co );
  ...
  XNR2D1BWP16P90 U2 ( .A1(n1), .A2(n5), .ZN(s) );
  XOR2D1BWP16P90LVT U3 ( .A1(n3), .A2(b), .Z(n5) );
  INVD1BWP16P90LVT U4 ( .I(a), .ZN(n3) );
  INVD1BWP16P90LVT U5 ( .I(ci), .ZN(n4) );
  INVD1BWP16P90LVT U6 ( .I(b), .ZN(n2) );
  OAI22D1BWP16P90LVT U7 ( .A1(n5), .A2(n4), .B1(n3), .B2(n2), .ZN(co) );
endmodule
...
module FA_structure_reg_2 ( a, b, ci, s, co );
  ...
  BUFFD1BWP16P90 U1 ( .I(ci), .Z(n1) );
  OAI22D2BWP16P90LVT U2 ( .A1(n5), .A2(n4), .B1(n3), .B2(n2), .ZN(co) );
...
module FA_structure_reg_3 ( a, b, ci, s, co );
  ...
  OAI22D2BWP16P90LVT U1 ( .A1(n4), .A2(n3), .B1(n2), .B2(n1), .ZN(co) );
  CKND1BWP16P90LVT U2 ( .I(ci), .ZN(n3) );
...
module FA_structure_reg_5 ( a, b, ci, s, co );
  ...
  INVD1BWP16P90LVT U1 ( .I(ci), .ZN(n3) );
  XOR2D1BWP16P90LVT U2 ( .A1(n3), .A2(n4), .Z(s) );
  OAI22D1BWP16P90LVT U3 ( .A1(n4), .A2(n3), .B1(n2), .B2(n1), .ZN(co) );
  XOR2D1BWP16P90LVT U4 ( .A1(n2), .A2(b), .Z(n4) );
  INVD1BWP16P90LVT U5 ( .I(a), .ZN(n2) );
  INVD1BWP16P90LVT U6 ( .I(b), .ZN(n1) );
endmodule
...
module FA_structure_reg_6 ( a, b, ci, s, co );
  ...
  XNR2D1BWP16P90 U1 ( .A1(n4), .A2(ci), .ZN(s) );
  XOR2D1BWP16P90LVT U2 ( .A1(n2), .A2(b), .Z(n4) );
  INVD1BWP16P90LVT U3 ( .I(a), .ZN(n2) );
  INVD1BWP16P90LVT U4 ( .I(ci), .ZN(n3) );
  INVD1BWP16P90LVT U5 ( .I(b), .ZN(n1) );
  OAI22D1BWP16P90LVT U6 ( .A1(n4), .A2(n3), .B1(n2), .B2(n1), .ZN(co) );
endmodule
...
module FA_structure_reg_7 ( a, b, ci, s, co );
  ...
  XNR2D1BWP16P90LVT U1 ( .A1(n4), .A2(ci), .ZN(s) );
  OAI22D1BWP16P90LVT U2 ( .A1(n4), .A2(n3), .B1(n2), .B2(n1), .ZN(co) );
  CKND1BWP16P90LVT U3 ( .I(ci), .ZN(n3) );
  XOR2D1BWP16P90LVT U4 ( .A1(n2), .A2(b), .Z(n4) );
  INVD1BWP16P90LVT U5 ( .I(a), .ZN(n2) );
  INVD1BWP16P90LVT U6 ( .I(b), .ZN(n1) );
endmodule
...
module FA_structure_reg_11 ( a, b, ci, s, co );
  ...
  XNR2D1BWP16P90 U1 ( .A1(ci), .A2(n4), .ZN(s) );
  XOR2D1BWP16P90LVT U2 ( .A1(n2), .A2(b), .Z(n4) );
  INVD1BWP16P90LVT U3 ( .I(a), .ZN(n2) );
  INVD1BWP16P90LVT U4 ( .I(ci), .ZN(n3) );
  INVD1BWP16P90LVT U5 ( .I(b), .ZN(n1) );
...
module FA_structure_reg_17 ( a, b, ci, s, co );
  ...
  XOR2D1BWP16P90 U1 ( .A1(n3), .A2(n4), .Z(s) );
  XOR2D1BWP16P90LVT U2 ( .A1(n2), .A2(b), .Z(n4) );
  OAI22D1BWP16P90LVT U3 ( .A1(n4), .A2(n3), .B1(n2), .B2(n1), .ZN(co) );
  INVD1BWP16P90LVT U4 ( .I(ci), .ZN(n3) );
  INVD1BWP16P90LVT U5 ( .I(a), .ZN(n2) );
...
module FA_structure_reg_26 ( a, b, ci, s, co );
  ...
  INVD1BWP16P90LVT U1 ( .I(ci), .ZN(n3) );
  XNR2D1BWP16P90LVT U2 ( .A1(ci), .A2(n4), .ZN(s) );
  XOR2D1BWP16P90LVT U3 ( .A1(n2), .A2(b), .Z(n4) );
  INVD1BWP16P90LVT U4 ( .I(a), .ZN(n2) );
  INVD1BWP16P90LVT U5 ( .I(b), .ZN(n1) );
  OAI22D1BWP16P90LVT U6 ( .A1(n4), .A2(n3), .B1(n2), .B2(n1), .ZN(co) );
...
module FA_structure_reg_30 ( a, b, ci, s, co );
  ...
  OAI22D1BWP16P90LVT U4 ( .A1(n5), .A2(n4), .B1(n3), .B2(n2), .ZN(co) );
  XOR2D1BWP16P90LVT U5 ( .A1(n3), .A2(b), .Z(n5) );
  INVD1BWP16P90LVT U6 ( .I(a), .ZN(n3) );
  INVD1BWP16P90LVT U7 ( .I(b), .ZN(n2) );
endmodule
...
module FA_structure_reg_31 ( a, b, ci, s, co );
  ...
  CKND1BWP16P90LVT U1 ( .I(ci), .ZN(n3) );
  OAI22D1BWP16P90LVT U2 ( .A1(n4), .A2(n3), .B1(n2), .B2(n1), .ZN(co) );
  XOR2D1BWP16P90LVT U3 ( .A1(n3), .A2(n4), .Z(s) );
  XOR2D1BWP16P90LVT U4 ( .A1(n2), .A2(b), .Z(n4) );
  INVD1BWP16P90LVT U5 ( .I(a), .ZN(n2) );
...
module adder_structure_reg ( s_co, a, b, ci, clk );
  ...
  XOR3D1BWP16P90LVT U4 ( .A1(b[31]), .A2(a[31]), .A3(carry[32]), .Z(
        sum_comb[32]) );
endmodule
